default[:tomcat][:instance_name] = 'tomcat'
default[:tomcat][:version] = '9.0.1'
default[:tomcat][:install_path] = "/usr/local/#{node[:tomcat][:instance_name]}/#{node[:tomcat][:version]}"
...
default[:tomcat][:tarball_path] = "#{Chef::Config[:file_cache_path]}"
default[:tomcat][:exclude_docs] = 'true'
